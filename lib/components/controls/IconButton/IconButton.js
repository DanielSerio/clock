...
export default function IconButton({ name, color, onClick }) {
  return (
    <svg className="icon-btn" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" onClick={onClick}>
      {name === 'palette' &&
